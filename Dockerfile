...
RUN apt-get update && apt-get upgrade -y && apt-get install -y \
    ...
    libproj-dev munin-node munin libprotobuf-c0-dev protobuf-c-compiler \
    ...
    ttf-unifont lua5.1 liblua5.1-dev libgeotiff-epsg curl sudo make cmake g++ \
    ...
    postgresql-10-postgis-scripts autoconf apache2-dev libtool libxml2-dev \
    libbz2-dev libgeos-dev libgeos++-dev libproj-dev gdal-bin libmapnik-dev \
    mapnik-utils python-mapnik fonts-noto-cjk fonts-noto-hinted \
